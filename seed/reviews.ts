...
export const review : Review[] = [
...

  {
    ...
    reviewerName: "FilmFanatic89",
    rating: 6,
    content: "A decent movie with some interesting twists. While the plot was engaging, there were moments that felt a bit cliché. Overall, an enjoyable watch.",
    reviewDate: "01/25/2023"
  },
